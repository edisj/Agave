...
mpiexec -n 1 python -W ignore /scratch/ejakupov/Agave/benchmarks/chunked/writer2/scripts/benchmark.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x_chunked.h5md $1/1node_$2
