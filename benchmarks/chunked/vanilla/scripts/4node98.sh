...
mpiexec -n 98 python -W ignore /scratch/ejakupov/Agave/benchmarks/chunked/vanilla/scripts/benchmark.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x_chunked.h5md $1/4node_$2
