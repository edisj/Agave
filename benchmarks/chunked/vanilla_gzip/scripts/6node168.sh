...
mpiexec -n 168 python -W ignore /scratch/ejakupov/Agave/benchmarks/chunked/vanilla_gzip/scripts/benchmark.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x_chunked_gzip.h5md $1/6node_$2
