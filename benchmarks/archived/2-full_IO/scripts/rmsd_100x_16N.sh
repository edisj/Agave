...
do
    mpiexec -n $i python /scratch/ejakupov/parallel_h5md/scripts/rmsd/90Kframe/rmsd_parallel_bench_100x.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x.h5md $1
done
