...
for i in 28 42 56
do
    mpiexec -n $i python /scratch/ejakupov/parallel_h5md/scripts/gen2/Agave/rmsd/90Kframe/h5py_rmsd_parallel_bench_100x.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x.h5md $1
done
