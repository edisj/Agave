...
do
    ...
    do
        mpiexec -n $i python /scratch/ejakupov/parallel_h5md/scripts/Agave/gen3/rmsd/90Kframe/only_load_CA_bench.py $testdir/alpha_carbons.pdb $testdir/YiiP_system_9ns_center100x.h5md $1/16node_$j
    done
done
