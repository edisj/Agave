...
mpiexec -n 168 python -W ignore /scratch/ejakupov/Agave/benchmarks/contiguous/vanilla/scripts/benchmark.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x_contiguous.h5md $1/6node_$2
