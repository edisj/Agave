...
mpiexec -n 448 python -W ignore /scratch/ejakupov/Agave/benchmarks/masked_array_1/scripts/benchmark.py $testdir/YiiP_system.pdb $testdir/YiiP_system_9ns_center100x.h5md $1/16node_$2
